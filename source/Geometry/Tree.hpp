...
namespace Geometry
{
	...
	//	Tree<QuadrantTraits> or Tree<OctantTraits> respectively

	// An aligned tree subdivides a 3 dimentional space into aligned partitions.
	...
	public:
		...
		typedef Numerics::Vector<D> VecT;
		typedef Box<D> SpaceT;
	...
	public:
		...
		public:
			Partition (Tree * base, const VecT & origin, const VecT & size) : _origin(origin), _size(size), _level(0)
			{
				_parent = NULL;
