...
namespace Geometry
{
	UnitTest::Suite EyeTestSuite {
		...
		{"Orthographic Projection",
			[](UnitTest::Examiner & examiner) {
				auto box = Box3::from_center_and_size(ZERO, 10);

				auto eye = eye_transformation<RealT>(orthographic_projection(box), Transforms::translate(Vec3(10, 10, 0)));
